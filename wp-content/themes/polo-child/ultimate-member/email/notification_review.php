...
<div style="background: #eee; color: #444; padding: 12px 15px; border-radius: 3px; font-weight: bold; font-size: 16px;">Here is the submitted registration form:<br /><br />{submitted_registration}
<p>User {display_name} is requesting access as {usermeta:user_role}</div>
</div>
</div>

...
class Easy_Timetable_Public {
	...
	public function enqueue_scripts() {
		wp_enqueue_script( $this->plugin_name . "uikit", plugin_dir_url( __FILE__ ) . 'js/uikit.min.js', "", $this->version, false );
		wp_enqueue_script( $this->plugin_name . "uikit-icon", plugin_dir_url( __FILE__ ) . 'js/uikit-icons.min.js', "", $this->version, false );
